...
.paper-card {
  width: 380px; padding: 44px 36px; background: var(--paper-warm);
  border: 3px solid var(--paper-dark); border-radius: var(--radius-lg);
  box-shadow: var(--shadow-lg); position: relative;
}
.card-tape {
  position: absolute; top: -12px; left: 50%; transform: translateX(-50%) rotate(-2deg);
  width: 60px; height: 24px; background: rgba(192, 152, 64, 0.3);
