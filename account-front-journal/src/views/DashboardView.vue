...
.sticky {
  padding: 24px 20px; border-radius: 4px 16px 4px 16px;
...
.family-tape {
  ...
  background: var(--paper-cream); border-radius: 6px 18px 6px 18px;
...
@media (max-width: 768px) {
  .sticky-notes, .charts-row { grid-template-columns: 1fr; }
}
</style>
